...
import edu.upenn.cis350.LoginHandler;
import edu.upenn.cis350.StudentObject;

/**
 * Screen where user can remove a student from
 * a particular activity's roster.
 */
public class RemoveStudentMainActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
    	System.out.println("In removeMain Oncreate!");
    ...
    public void createList() {
    	System.out.println("In RemoveStudentMain CreateList");
    	...
    	if (id == REMOVE) {
	    	...
	    	builder.setPositiveButton("Remove", new DialogInterface.OnClickListener() {
	    		public void onClick(DialogInterface dialog, int id) {
	    			...
	    			ParseHandler.removeStudentFromActivityMain(studentID);
